...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks =  -1146.1432783379762; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -710.2208782585255; // x position of the perpendicular encoder (in tick units)
    }
